...
namespace XXX_MissileSim {  
    ...
    extern "C" { //C风格导出，保证兼容多平台
		...
		MISSILE_SIM_API void CopyMissile();				//【导出函数】-复制构造函数
		MISSILE_SIM_API void AssignMissile();			//【导出函数】-拷贝赋值函数
		...
		MISSILE_SIM_API OutputParams GetMissileState_C(void* missile); //【导出函数】-获取导弹参数
